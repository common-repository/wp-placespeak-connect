...
function on_activate( $network_wide ) {
    ...
    if ( is_multisite() && $network_wide ) {
        ...
        foreach ( $blog_ids as $blog_id ) {
            ...
            ps_placespeak_install();
            ps_placespeak_install_data();
...
function on_create_blog( $blog_id, $user_id, $domain, $path, $site_id, $meta ) {
    if ( is_plugin_active_for_network( 'wp-placespeak-connect/placespeak.php' ) ) {
        switch_to_blog( $blog_id );
        ps_placespeak_install();
        ps_placespeak_install_data();
        restore_current_blog();
...
function ps_placespeak_scripts() {
    ...
    wp_localize_script( 'placespeak-js','ps_params',array('site_url' => get_site_url()));
